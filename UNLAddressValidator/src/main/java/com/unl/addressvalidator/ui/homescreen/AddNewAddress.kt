...
fun UnlValidatorActivity.nodatafund()
{

}

fun UnlValidatorActivity.setAddressFromCurrentLcation() {
...
fun UnlValidatorActivity.updateAddressButton() {
...
fun UnlValidatorActivity.setNewAddressClick() {
...
fun UnlValidatorActivity.createAddress() {
...
fun UnlValidatorActivity.parseSearchResultJson(rawData: JsonObject) {
...
fun UnlValidatorActivity.setAddressFromSearchResult(
    houseNumber: String,
    cityDistrict: String,
...
fun UnlValidatorActivity.selectedLabel(position: Int) {
    ...
    if (position == 0) {
        ...
        img = getResources().getDrawable(R.drawable.ic_office)
    } else if (position == 2) {
        ...
        img = getResources().getDrawable(R.drawable.ic_add_lable)
    }
...
fun UnlValidatorActivity.clearAddressFields() {
...
fun UnlValidatorActivity.setCurrentAddress() {
    var houseNo =
        reverseGeoCodeCurrentLocationResponse!!.features!!.get(0).properties!!.postal_address.get(0).house_number
    var streetName =
        reverseGeoCodeCurrentLocationResponse!!.features!!.get(0).properties!!.postal_address.get(0).street_address
    var city =
        reverseGeoCodeCurrentLocationResponse!!.features!!.get(0).properties!!.postal_address.get(0).city_district
    var pincode =
        reverseGeoCodeCurrentLocationResponse!!.features!!.get(0).properties!!.postal_address.get(0).postal_code
    var state =
        reverseGeoCodeCurrentLocationResponse!!.features!!.get(0).properties!!.postal_address.get(0).state_district


    currentAddressText = ""+Utility.returnFullAddress(houseNo, "", "", streetName, city, state, pincode)
